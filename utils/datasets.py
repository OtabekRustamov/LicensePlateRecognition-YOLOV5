...
def create_dataloader(path, imgsz, batch_size, stride, opt, hyp=None, augment=False, cache=False, pad=0.0, rect=False,
    ...
    with torch_distributed_zero_first(rank):
        dataset = Dataset(path, imgsz, batch_size,
    ...
    nw = os.cpu_count() // world_size  # number of workers
...
class Dataset(data.Dataset):  # for training/testing
            ...
            for p in path if isinstance(path, list) else [path]:
                ...
                if p.is_dir():  # dir
                    ...
                    with open(p, 'r') as t:
                        ...
                        f += [parent + 'images/' + x + '.jpg' for x in t]
                else:
